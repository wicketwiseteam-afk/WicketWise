...
const FeatureCard = ({ title, icon, width, description }) => (
  <div
    ...
    className={`relative ${width} group p-[2px] rounded-2xl 
  bg-gradient-to-br from-white via-gray-400 to-gray-700 
  transition-all duration-300 hover:shadow-[0_0_13px_#ff4da64D,0_0_13px_#ffa5004D]`}
  >
    <div className="relative w-full h-full md:min-h-[260px] px-8 py-8 rounded-[13px] bg-black text-white overflow-hidden">
