import GradientBlob from "./GradientBlobs";
const Herosection = () => {
  return (
    <section className="w-full bg-black text-white min-h-screen relative z\">
      
      <div className="max-w-6xl mx-auto flex flex-col justify-center items-center text-center h-full pt-24 pb-16 gap-y-10">
        
        {/* Title */}
        <h1 className="text-[100px] lg:text-[120px] font-extrabold leading-tight tracking-wide">
        ...
        {/* Tagline */}
        <p className="text-2xl md:text-4xl text-white/80 font-extralight max-w-4xl mt-6">
